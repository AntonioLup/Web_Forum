...
public class BlogFactory {
    public final static List<User> BLOG_USERS;
    ...
    private static List<User> generateBlogUsers() {
    ...
    public static User generateBlogAdmin() {
        return new User(
                "admin",
                "ADMIN",
    ...
    private static User generateBlogUser() {
    ...
    private static List<Comment> generateComments(Post post) {
        return Stream.generate(BlogFactory::generateComment)
                ...
                .peek(comment -> comment.getUser().addComment(comment))
